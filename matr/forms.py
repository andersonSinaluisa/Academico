...
class AnioLectivoCrearForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['fecha_incio_ciclo'] = forms.DateTimeField(
            widget=forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}))
        self.fields['fecha_fin_ciclo'] = forms.DateTimeField(
            widget=forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}))
...
class CabCursoCrearForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['anio_lectivo'] = forms.ChoiceField(label=_("Año lectivo"),
                                                        choices=[(i.id_anio_lectivo, str(i.anio) + "-" + str(i.ciclo))
                                                                 for i in AnioLectivo.objects.filter(estado=True)])
        for field in iter(self.fields):
            self.fields[field].widget.attrs.update({
                'class': 'form-control'
            })
