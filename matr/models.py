...
class CabCurso(models.Model):
    ...
    id_cfg_regimen = models.ForeignKey(GenrGeneral, default=97, on_delete=models.CASCADE, blank=False, related_name='fk_cabcurso_regimen', null=False, db_column='id_cfg_regimen',verbose_name=_("Regimen"))
    id_cfg_modalidad = models.ForeignKey(GenrGeneral, default=97, on_delete=models.CASCADE, blank=False, null=False, related_name='fk_cabcurso_modalidad', db_column='id_cfg_modalidad',verbose_name=_("Modalidad"))
    id_cfg_tipo_edu = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, blank=False, null=False, related_name='fk_materiaprof_tipoedu', db_column='id_cfg_tipo_educacion',verbose_name=_("Tipo de educación"))
    id_cfg_formacion = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, blank=False, null=False, related_name="fk_cabcurso_formacion", db_column='id_cfg_formacion',verbose_name=_("Formación"))
    id_cfg_jornada = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, blank=False, null=False, related_name= "fk_cabcurso_jornada", db_column='id_cfg_jornada',verbose_name=_("Jornada"))
...
class Aniolectivo_curso(models.Model):
    ...
    def __str__(self):
        return  self.id_curso.nombre+" "+self.id_curso.id_cfg_formacion.nombre+" "+self.paralelo+" "+str(self.id_anio_electivo.anio)
