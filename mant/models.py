...
class Persona(models.Model):
    ...
    id_cfg_idioma_ancestral = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="acestral",
                                                db_column='id_cfg_idioma_ancestral', null=True,verbose_name=_('Idioma ancestral'))
    id_cfg_categoria_migratoria = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE,
                                                    related_name="categoria_migratoria",
                                                    db_column='id_cfg_categoria_migratoria', null=True,verbose_name=_('Categoria migratoria'))
    ...
    id_cfg_estado_civil = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, blank=True, null=True,
                                            related_name="estado_civil", db_column='id_cfg_estado_civil',verbose_name=_('Estado civil'))
    ...
    discapacidad_neurologica = models.BooleanField(blank=True, null=True,verbose_name=_('Padece de enfermedad neurológica'))
    ...
    enfermedad_respiratoria = models.BooleanField(blank=True, null=True,verbose_name=_('Padece enfermedad respiratoria'))
    ...
    id_cfg_estado_laboralp = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE, related_name="estado_laboralp",
                                               db_column='id_cfg_estado_laboralp', blank=False, null=True,verbose_name=_('Estado laboral del padre'))
    ...
    midentificacion = models.CharField(max_length=15, blank=True, null=True,verbose_name=_('Identificación de la madre'))
    ...
    id_cfg_estado_laboralm = models.ForeignKey(GenrGeneral, blank=True, null=True, on_delete=models.CASCADE,
                                               related_name="estado_laboralm", db_column='id_cfg_estado_laboralm',verbose_name=_('Estado laboral de la madre'))
    bono_solidario = models.BooleanField(blank=True, null=True,verbose_name=_('Representante recibe bono solidario'))

    rnombres = models.CharField(max_length=45, blank=True, null=True, default="nombre representante",verbose_name=_('Nombre Representante'))
    rapellidos = models.CharField(max_length=45, blank=True, null=True, default="apellido representante",verbose_name=_('Apellido Representante'))
    ...
    id_cfg_tipo_identificacion = models.ForeignKey(GenrGeneral, on_delete=models.CASCADE,
                                                   ...
                                                   db_column='id_cfg_tipo_identificacion', null=True,verbose_name=_('Tipo Identificación Representante'))
    ridentificacion = models.CharField(max_length=13, blank=True, null=True,verbose_name=_('Identificación del Representante'))
    ...
    rdireccion_trabajo = models.CharField(max_length=200, blank=True, null=True,verbose_name=_('Dirección trabajo representante'))
    rtelefono_trabajo = models.CharField(max_length=20, blank=True, null=True,verbose_name=_('Telefono trabajo representante'))
